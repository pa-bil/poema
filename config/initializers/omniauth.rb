Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  OmniAuth.config.full_host = 'https://' + Poema::Application::custom_config(:site_hostname)
  ...
  provider :facebook, Poema::Application::custom_config(:facebook_key), Poema::Application::custom_config(:facebook_secret), :scope => 'email,user_location,user_hometown,publish_stream,user_website'
end
